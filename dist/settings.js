...
const Header = ({
  ...
  const headerLeftContent = React.createElement(
    Container,
    {
      containerType: "flex",
      gap: header.gap,
    ...
    React.createElement(
      "div",
      { className: "bsf-ui-header-logo", style: { display: "flex" } },
      logo,
    ),
    React.createElement(
      Container,
...
const Sidebar = ({
  listItems,
  listItemColor = sidebar.listItemColor,
  listItemHoverColor = sidebar.listItemHoverColor,
  listIconColor = sidebar.listIconColor,
  listIconHoverColor = sidebar.listIconHoverColor,
  listItemBackgroundColor = sidebar.listItemBackgroundColor,
  listItemHoverBackgroundColor = sidebar.listItemHoverBackgroundColor,
  listStyle,
  className,
  activeItem,
}) => {
