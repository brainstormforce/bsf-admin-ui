...
const WpFileUploader = (props) => {
    ...
    return (React.createElement("div", { className: containerClass },
        React.createElement("button", { className: containerStyle, ref: buttonRef, "aria-label": "Upload file" },
            React.createElement("span", { className: "surerank-seo-popup-upload-input-area" }, "Choose file"),
            React.createElement("span", { className: "surerank-seo-popup-upload-button" }, uploadButtonText))));
};
