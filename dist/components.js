...
const inputPicker = {
    ...
    boxShadow: "var(--bsf-admin-input-picker-box-shadow, 0px 1px 2px 0px " +
        color.borderLight +
        ")",
};
const button = {
    ...
    hoverBackgroundColor: "var(--bsf-admin-button-hover-background-color, " +
        color.primaryHover +
        ")",
...
const card = {
    ...
    boxShadow: "var(--bsf-admin-card-box-shadow, 0px 1px 2px 0px " +
        color.borderLight +
        ")",
...
const multiButton = {
    background: "var(--bsf-admin-multi-button-background-color, " +
    ...
    outlineBorder: "var(--bsf-admin-multi-button-outline-border, 1px solid " +
        color.borderLight +
        ")",
